...
class Cancelled extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->setTransactionIdToOrder();
            $this->restoreCart($errorMsg);
            $this->_messageManager->addErrorMessage("PAYKUN Couldn't send mail from your environment please check your SMTP settings.");
            $this->addLog("PAYKUN Couldn't send mail from your environment please check your SMTP settings. 
            for the transaction id =>".$this->TXN_ID);
